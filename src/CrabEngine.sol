...
contract CrabEngine is ReentrancyGuard, ICrabEngine {
    ...
    // State Variables
    ///////////////////
    CrabStableCoin private immutable i_dsc;
    ...
    constructor(address[] memory tokenAddresses, address[] memory priceFeedAddresses, address dscAddress) {
        ...
        i_dsc = CrabStableCoin(dscAddress);
    }
        ...
        nonReentrant
    {
        ...
        if (startingUserHealthFactor >= MIN_HEALTH_FACTOR) {
            revert CrabEngine__HealthFactorOk();
        }
        ...
        if (endingUserHealthFactor <= startingUserHealthFactor) {
            revert CrabEngine__HealthFactorNotImproved();
        }
        revertIfHealthFactorIsBroken(msg.sender);
    }
    ...
    function revertIfHealthFactorIsBroken(address user) internal view {
        ...
        if (userHealthFactor < MIN_HEALTH_FACTOR) {
            revert CrabEngine__BreaksHealthFactor(userHealthFactor);
        }
    }
